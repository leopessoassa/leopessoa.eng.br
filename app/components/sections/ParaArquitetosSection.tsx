      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-secondary-200 rounded-lg border-l-4 border-red-400">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-secondary-200 rounded-lg border-l-4 border-success-400">
                <div className="w-8 h-8 bg-success-100 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                  <svg
              ...
              <div className="flex items-start gap-4 p-4 bg-secondary-200 rounded-lg border-l-4 border-primary-400">
              ...
              <div className="flex items-start gap-4 p-4 bg-secondary-200 rounded-lg border-l-4 border-accent-400">
        ...
        <div className="bg-secondary-50 rounded-2xl p-8 lg:p-12 shadow-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="bg-secondary-200 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <svg
