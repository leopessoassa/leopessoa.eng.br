      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-secondary-50">
            ...
            <span className="text-accent-500">dores técnicas</span>
          </h1>

          <p className="text-xl md:text-2xl mb-8 text-secondary-100 max-w-3xl mx-auto leading-relaxed">
            Automação residencial que seus clientes{" "}
            <strong className="text-secondary-50">entendem</strong> e{" "}
            <strong className="text-secondary-50">aprovam no orçamento</strong>.
            Parceria técnica descomplicada para arquitetos e design de
            interiores em João Pessoa.
          </p>
