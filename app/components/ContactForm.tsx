      ...
      >
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-lg border-2 focus:outline-none transition-colors ${
                isSubmitting ? "bg-secondary-50" : ""
              } ${
                errors.name
                  ? "bg-red-100 border-red-100 focus:ring-red-100 text-red-700"
                  : "border-secondary-100/20 focus:border-accent-500 text-secondary-900 bg-white"
              }`}
            />
            {errors.name && (
          ...
          <div>
            ...
            />
            {errors.cel && (
              <p className="mt-1 text-sm text-red-400">{errors.cel.message}</p>
            )}
          </div>
        </div>
