...
export const meta: MetaFunction = () => {
  return [
    {
      title:
        "Leo Pessoa - Engenheiro Eletricista João Pessoa | Projetos Elétricos e Automação Residencial",
    },
    {
      name: "description",
      content:
        "Engenheiro eletricista em João Pessoa-PB especializado em projetos elétricos e automação residencial. Parceiro técnico para arquitetos com expertise em BIM e AutoCAD.",
    },
    {
      name: "keywords",
      content:
        "engenheiro eletricista João Pessoa, projetos elétricos Paraíba, automação residencial João Pessoa, BIM AutoCAD, arquitetos João Pessoa, CREA-PB",
    },
    {
      property: "og:title",
      content: "Leo Pessoa - Engenheiro Eletricista João Pessoa",
    },
    {
      property: "og:description",
      content:
        "Parceiro técnico para arquitetos em João Pessoa. Projetos elétricos e automação residencial com BIM e AutoCAD.",
    },
